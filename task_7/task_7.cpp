...
вводим 31 декабря 2121 года, то 1 января 2122 года
	2000.2.27 => 2000.2.28 => ok
	2000.2.28 => 2000.2.29 => ok
	2000.2.29 => 2000.3.1 => ok
	2000.3.31 => 2000.1.4 => ok
	2000.4.30 => 2000.5.1 => ok

	2001.2.27 => 2001.2.28 => ok
	2001.2.28 => 2001.3.1 => ok
	2121.12.31 => 2122.1.1 => ok
*/
		...
		if (date_month > 0 && date_month < 13)
		{
				...
				)
			{
				...
				case February: // расчет следующей даты за введенной, для февраля (как высокосного так и не высокосного)
					date_day++;
					if (!(date_year % 400 == 0 || (date_year % 100 != 0 && date_year % 4 == 0)) && (date_day > 28)) // не високосный
					{
						date_day = 1;
						date_month++;
						if (date_month > 12)
					...
					else if ((date_year % 400 == 0 || (date_year % 100 != 0 && date_year % 4 == 0)) && (date_day > 29)) // високосный
					{
						date_day = 1;
						date_month++;
						if (date_month > 12)
